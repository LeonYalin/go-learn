...
import (
	...
	"github.com/LeonYalinAgentVI/go-learn/src/10.sendingEmails/project/internal/forms"
	...
	"github.com/LeonYalinAgentVI/go-learn/src/10.sendingEmails/project/internal/repository/dbrepo"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	// send a notification - first to guest
	msg := models.MailData{
		...
		Template: "basic.html",
		Content: fmt.Sprintf(`
		<strong>Resetvation confirmation</strong>
		Dear %s: <br>
		This is to conform your reservation from %s to %s.
		`, reservation.FirstName, reservation.StartDate.Format(layout), reservation.EndDate.Format(layout)),
	}
	m.App.MailChan <- msg

	// send a notification - to property owner
	msg = models.MailData{
		From:    "lyalin@gmail.com",
		To:      "lyalin@gmail.com",
